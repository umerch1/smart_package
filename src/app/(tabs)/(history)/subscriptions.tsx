...
import { getSubscriptionHistory } from "@/services/historyService";

export default function SubscriptionHistoryScreen() {
  const records = getSubscriptionHistory();
  return (
        ...
        <ScrollView contentContainerStyle={styles.content}>
          <View style={styles.header}>
            <View>
              ...
              <ThemedText style={styles.title}>Subscription history</ThemedText>
            </View>
